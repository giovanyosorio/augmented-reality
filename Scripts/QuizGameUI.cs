...
#pragma warning disable 649
    ...
    [SerializeField] private Text scoreText,scoreText2, timerText;
...
#pragma warning restore 649
    ...
    public Text ScoreText2 { get => scoreText2; }

    public GameObject GameOverPanel { get => gameOverPanel; }                     //getter
    private string ukey = "accountusername";
    private void Start()
    {
        Debug.Log("hashkey desde quiz" + PlayerPrefs.HasKey(ukey));
        Debug.Log("get string desde quiz" + PlayerPrefs.GetString(ukey));
